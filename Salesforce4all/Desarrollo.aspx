<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Desarrollo.aspx.vb" Inherits="Salesforce4all.Desarrollo" %>
...
<%--                <li class="nav-item">
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url('Images/Index2.png')">
          ...
          <div class="carousel-item" style="background-image: url('Images/Index1.png')">
            <div class="carousel-caption d-none d-md-block">
              <h3></h3>
              <p>T</p>
            </div>
          ...
          <div class="carousel-item" style="background-image: url('Images/Index3.png')">
            <div class="carousel-caption d-none d-md-block">
              <h3></h3>
              <p></p>
            </div>
                ...
                <div class="col-lg-4 col-sm-6 portfolio-item">
                 ...
                 <div class="col-lg-4 col-sm-6 portfolio-item">
                    <div class="card h-100">
                        <a href="#">
                            <%--<img class="card-img-top" src="http://placehold.it/700x400" alt=""></a>--%>
                         <img class="card-img-top" src="Images/new-model.png" alt=""></a>
                        <div class="card-body">
                            <h4 class="card-title">
                        ...
                        <div class="card-body">
                            <div class="picker">
                                <select runat="server" title="Selecciona tu imagen preferida" class="image-picker show-labels show-html" id="imageSelected"  style="display: none">
                                    ...
                                    <option data-img-src='Images/12/header-bg-16.png' value='header-bg-16'>Christmas</option>
                                </select>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-12">
                                    <ul class="list-unstyled mb-0">
                                       <%-- <li>
                                        ...
                                        <li>
                                                <p class="card-text"><b>2.</b> On <b>Verify a Salesforce Certified Professional</b>  Section submit your <b>full name or email associated to webassesor</b> </p>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                         ...
                                         <li>
                                                <p class="card-text"><b>8.</b> Copy the searchString value at the end of url, it look like this:   <b>003G000002S9aeZIAR</b></p>
                                        </li>
                                         <li>
             ...
             <div class="card my-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-lg-6">
                                 ...
                                 <div class="col-lg-6">
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li>
                                           <asp:TextBox runat="server" ID="idSalesforce" class="form-control" placeholder="Example: 003G000002S9aeZIAR"></asp:TextBox>
                            ...
                            <br />
                             ...
                             <br />
                             <asp:Label ID="LabelInputMessageValidation" runat="server"></asp:Label>
