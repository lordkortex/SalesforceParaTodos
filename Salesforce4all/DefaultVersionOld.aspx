<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DefaultVersionOld.aspx.vb" Inherits="Salesforce4all.DefaultVersionOld" %>
                ...
                <!--<asp:Image ID="Image1" runat="server" Height = "100" Width = "100" />-->
                        ...
                        <div class="card-body">
                            <div class="picker" id="drawZoneUploadFile" >
                                <select runat="server" title="Selecciona tu imagen preferida" class="image-picker show-labels show-html" id="imageSelected"  style="display: none" multiple>
